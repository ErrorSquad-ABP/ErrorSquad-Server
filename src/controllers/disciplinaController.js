...
async function requestNewDisciplina(req, res) {
    ...
    const newDisciplinaDto = new createDisciplinaDto(defaultNomeString, req.body.id_docente, req.body.id_curso);

    try {
        const newDisciplina = new disciplina(null, newDisciplinaDto.nome, newDisciplinaDto.id_docente, newDisciplinaDto.id_curso)
...
async function requestAlterDisciplina(req, res) {
    ...
    const defaultNomeString = defaultStrings.firstLetterUppercase(req.body.nome);
    const alterDisciplina = new disciplina(req.body.id, defaultNomeString, req.body.id_docente, req.body.id_curso);
